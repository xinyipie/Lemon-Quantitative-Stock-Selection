...
class TestAIConfig(unittest.TestCase):
    ...
    def test_tushare_accepts_original_relay_and_https_override(self):
        self.assertEqual(config.require_secure_tushare_url("http://14.nat0.cn:32817/"), "http://14.nat0.cn:32817")
    ...
    def test_tushare_rejects_unrelated_http_or_embedded_credentials(self):
        for value in ("http://other.example", "http://14.nat0.cn:32817/other", "https://user:password@provider.example", "ftp://provider.example", ""):
