...
# 短线实盘硬风控：不改变回测定板评分，只在 live 推送前拦截明显高危股票
ENABLE_SHORT_LIVE_RISK_GUARD = True
SHORT_RISK_MIN_ROE = -20.0
SHORT_RISK_MAX_DEBT_RATIO = 90.0
SHORT_RISK_MIN_REVENUE_GROWTH = -50.0
SHORT_RISK_MIN_NETPROFIT_YOY = -70.0
SHORT_RISK_WEAK_ROE_FOR_PROFIT_COLLAPSE = 3.0
